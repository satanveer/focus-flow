    ...
    <div className="flex-1 p-4">
      <div className="max-w-4xl">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-bold" style={{ color: 'var(--text)' }}>Upcoming Events</h3>
        ...
        {upcomingEvents.length > 0 ? (
          <div className="space-y-2">
            {upcomingEvents.map((event) => {
              ...
              return (
                <div
                  key={event.id}
                  className="rounded-lg cursor-pointer transition-all duration-200 hover:scale-[1.01] hover:shadow-md overflow-hidden"
                  style={{
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                          <h4 className="text-sm font-semibold" style={{ color: 'var(--text)' }}>{event.title}</h4>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-base font-bold mb-2" style={{ color: 'var(--text)' }}>No upcoming events</h3>
